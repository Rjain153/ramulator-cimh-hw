...
private:
    ...
    int master_uxi_switches = 0;
    int slave_uxi_switches = 0;
    //int memory_controllers = 0;
    int channels;
    int ranks;
    int subarrays;
    int cpu_tick;
...
public:
    ...
    int get_master_uxi_switches() const { return master_uxi_switches;}
    int get_slave_uxi_switches_per_master() const {return slave_uxi_switches;}
    //int get_memory_controllers_per_slave_uxi_switch() const {return memory_controllers;};
