...
public:
    ...
    { 
      MasterUxiSwitch, SlaveUxiSwitch, Channel, Rank, BankGroup, Bank, Row, Column, MAX
    };
    ...
    enum class State : int
    {
      ...
      State::MAX, State::MAX, State::MAX, State::PowerUp, State::MAX, State::Closed, State::Closed, State::MAX
    };
    ...
    struct OrgEntry {
      ...
      {2<<10,  4, {0, 0, 0, 0, 4, 4, 1<<15, 1<<10}}, {2<<10,  8, {0, 0, 0, 0, 4, 4, 1<<14, 1<<10}}, {2<<10, 16, {0, 0,0 , 0, 2, 4, 1<<14, 1<<10}},
      {4<<10,  4, {0, 0, 0, 0, 4, 4, 1<<16, 1<<10}}, {4<<10,  8, {0, 0, 0, 0, 4, 4, 1<<15, 1<<10}}, {4<<10, 16, {0, 0, 0, 0, 2, 4, 1<<15, 1<<10}},
      {8<<10,  4, {0, 0, 0, 0, 4, 4, 1<<17, 1<<10}}, {8<<10,  8, {0, 0, 0, 0, 4, 4, 1<<16, 1<<10}}, {8<<10, 16, {0, 0, 0, 0, 2, 4, 1<<16, 1<<10}}
    }, org_entry;

    void set_master_uxi_switch_number(int num_master_uxi_switches);
    void set_slave_uxi_switch_number(int num_slave_uxi_switches);
