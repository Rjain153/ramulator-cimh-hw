...
string DDR4::level_str [int(Level::MAX)] = {"Ms", "Ss", "Ch", "Ra", "Bg", "Ba", "Ro", "Co"};
...
//@rajat: set the # of master uxi switches
void DDR4::set_master_uxi_switch_number( int num_master_uxi_switches ) {
  org_entry.count[int(Level::MasterUxiSwitch)] = num_master_uxi_switches;
}

//@rajat: set the # of slave uxi switches
void DDR4::set_slave_uxi_switch_number( int num_slave_uxi_switches ) {
  org_entry.count[int(Level::SlaveUxiSwitch)] = num_slave_uxi_switches;
}
